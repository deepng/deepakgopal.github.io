    ...
    <div className="flex flex-col gap-12">
      ...
      <section className="py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Project Card 2 */}
          <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
            <div className="h-40 bg-gradient-to-r from-purple-400 to-purple-600"></div>
            <div className="p-4">
              <h3 className="text-xl font-semibold mb-2">Project Two</h3>
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                A brief description of your second project and what technologies were used.
              </p>
              <a href="#" className="text-blue-600 hover:underline">View Project →</a>
            </div>
          </div>
          ...
          <div className="border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-4">
              ...
              <p className="text-zinc-600 dark:text-zinc-400 mb-4">
                A brief description of your third project and what technologies were used.
              </p>
              <a href="#" className="text-blue-600 hover:underline">View Project →</a>
            </div>
          </div>
      ...
      <section className="py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="border-b border-zinc-200 dark:border-zinc-800 pb-6">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-2">January 15, 2026</p>
            <p className="text-zinc-600 dark:text-zinc-400">
              An introduction to Next.js and how to build static websites with it.
            </p>
          </div>
          
          {/* Blog Post 2 */}
          <div className="border-b border-zinc-200 dark:border-zinc-800 pb-6">
            <h3 className="text-xl font-semibold mb-2">The Power of Static Site Generation</h3>
            <p className="text-sm text-zinc-500 dark:text-zinc-400 mb-2">December 20, 2025</p>
            <p className="text-zinc-600 dark:text-zinc-400">
              Why static sites are making a comeback and how they can benefit your projects.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="https://github.com/deepakgopal" className="hover:underline">github.com/deepakgopal</a>
              </div>
              <div className="flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-zinc-700 dark:text-zinc-300" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="flex-1">
            <div className="p-6 bg-zinc-100 dark:bg-zinc-800 rounded-lg">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 flex items-center justify-center bg-blue-600 text-white rounded-full hover:bg-blue-700 transition-colors">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.454C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z" />
                  </svg>
                </a>
                <a href="#" className="w-10 h-10 flex items-center justify-center bg-blue-400 text-white rounded-full hover:bg-blue-500 transition-colors">
